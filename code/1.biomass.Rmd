---
title: "Evolution of probiotic bacteria"
...
# Biomass response different diets (Fig. 1)
...
```{r}
png(filename="~/GitHub/MinimalCell/figures/1.main.text/Fig2.png",
...
# Show Plot
img <- readPNG("~/GitHub/MinimalCell/figures/1.main.text/Fig2.png")

grid.raster(img)
```

# Create figure for delta relative fitness (Figshare)

```{r}
png(filename="~/GitHub/MinimalCell/figures/4.figshare/1.delta_rel_fitness.png",
    width = 1200, height = 1200, res = 96*2) 
...
# Show Plot
img <- readPNG("~/GitHub/MinimalCell/figures/4.figshare/1.delta_rel_fitness.png")
