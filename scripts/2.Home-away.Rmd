...
# Create interaction plot - detla growth rate (Fig. 2)
...
# Create interaction plot - percent growth rate (Fig. 2)
...
# Start figures
png(filename="~/GitHub/Bifidobacterium/figures/Fig.2b.png",
    width = 1200, height = 1200, res = 96*2) 
...
# Add evolution labels
text(3.5, 18, labels = "Evolution", cex = 1.3, col = "black")
text(3.5, 16, labels = "diet:", cex = 1.3, col = "black")
segments(3.2, 15, 3.8, 15, col = "black", lwd = 1.5, xpd = NA)
...
# Show Plot
img <- readPNG("~/GitHub/Bifidobacterium/figures/Fig.2b.png")
grid.raster(img)
```