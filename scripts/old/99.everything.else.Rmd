...
# HPLC SECTION aka METABOLITE SECTION
```{r}
...
#Also, I recognized that there is no such argument as 'var.equal' when using a PAIRED t-test, but I'm leaving it in for explicative value. It is also good to do the variance test itself as a sanity check.
```
