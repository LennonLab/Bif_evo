...
anc <- read.csv("./Data/OD_20201104.csv")
...
evo <- read.csv("./Data/OD_evolved_20210509.csv")
...
```{r}
# Start figure
png(filename="~/GitHub/Bifidobacterium/figures/Fig.1a.png",
...
# Show Plot
img <- readPNG("~/GitHub/Bifidobacterium/figures/Fig.1a.png")
grid.raster(img)
```
